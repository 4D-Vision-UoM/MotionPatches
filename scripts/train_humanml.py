...
@hydra.main(version_base=None, config_name="config_point", config_path="../conf")
def main(cfg: DictConfig) -> None:
    ...
    # Use the same validation dataset for evaluation during training
